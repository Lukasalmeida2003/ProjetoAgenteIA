...
const Hero: React.FC = () => {
  ...
  const fullText = "Seem pensaar, sem errar, sem enrolar.";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          >
            ...
            >
              ...
              <div className="bg-background-light/50 backdrop-blur-sm border border-primary/20 rounded-lg p-6">
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-background-light to-background-dark rounded-2xl border border-primary/30 shadow-2xl overflow-hidden">
              {/* Dashboard Header */}
